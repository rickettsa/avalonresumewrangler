...
var inputType = {
  ...
  'text': textInputType,
     ...
     * modern browsers do not yet support this input type, it is important to provide cues to skillRoleMatrix on the
...
function baseInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  ...
  // In composition mode, skillRoleMatrix are still inputing intermediate text buffer,
 ...
 *   return $http.get('/api/skillRoleMatrix/' + value).
